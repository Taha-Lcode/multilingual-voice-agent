...
const publicKey = process.env.NEXT_PUBLIC_VAPI_PUBLIC_KEY || ""; // Use your actual public key
const assistantId = process.env.NEXT_PUBLIC_VAPI_ASSISTANT_ID || ""; // Use your actual assistant ID
